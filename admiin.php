<?php
//a:9:{s:4:"lang";s:2:"cn";s:9:"auth_pass";s:32:"f2984629222086294a7efa2da0725075";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";s:1:"0";s:7:"fm_root";s:0:"";s:17:"cookie_cache_time";i:2592000;s:7:"version";s:5:"0.9.8";}
/*--------------------------------------------------
 | PHP FILE MANAGER
 +--------------------------------------------------
...
function et($tag){
    ...
    $en['ErrorReport'] = 'Error Reporting';
        ...
        // china - by Fabricio Seger Kolling
    $cn['Version'] = '版本';
    $cn['DocRoot'] = 'Document Root';
    $cn['FLRoot'] = 'File Manager Root';
    $cn['Name'] = '名称';
    $cn['And'] = 'and';
    $cn['Enter'] = '输入';
    $cn['Send'] = '发送';
    ...
    $cn['CreateDir'] = '创建目录';
    $cn['CreateArq'] = '创建文件';
    $cn['ExecCmd'] = 'Execute Command';
    $cn['Upload'] = '上传';
    $cn['UploadEnd'] = '上传完成';
    $cn['Perm'] = 'Perm';
    $cn['Perms'] = 'Permissions';
    $cn['Owner'] = 'Owner';
    $cn['Group'] = 'Group';
    $cn['Other'] = 'Other';
    $cn['Size'] = '大小';
    ...
    $cn['File'] = '文件';
    $cn['File_s'] = 'file(s)';
    $cn['Dir_s'] = 'directory(s)';
    $cn['To'] = 'to';
    $cn['Destination'] = 'Destination';
    $cn['Configurations'] = 'Configurations';
    $cn['JSError'] = 'JavaScript Error';
    $cn['NoSel'] = 'There are no selected itens';
    $cn['SelDir'] = 'Select the destination directory on the left tree';
    $cn['TypeDir'] = 'Enter the directory name';
    $cn['TypeArq'] = 'Enter the file name';
    $cn['TypeCmd'] = 'Enter the command';
    $cn['TypeArqComp'] = 'Enter the file name.\\nThe extension will define the compression type.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $cn['RemSel'] = 'DELETE selected itens';
    $cn['NoDestDir'] = 'There is no selected destination directory';
    $cn['DestEqOrig'] = 'Origin and destination directories are equal';
    $cn['InvalidDest'] = 'Destination directory is invalid';
    $cn['NoNewPerm'] = 'New permission not set';
    $cn['CopyTo'] = 'COPY to';
    $cn['MoveTo'] = 'MOVE to';
    $cn['AlterPermTo'] = 'CHANGE PERMISSIONS to';
    $cn['ConfExec'] = 'Confirm EXECUTE';
    $cn['ConfRem'] = 'Confirm DELETE';
    $cn['EmptyDir'] = 'Empty directory';
    $cn['IOError'] = 'I/O Error';
    $cn['FileMan'] = 'PHP文件管理器';
    $cn['TypePass'] = 'Enter the password';
    $cn['InvPass'] = 'Invalid Password';
    $cn['ReadDenied'] = 'Read Access Denied';
    $cn['FileNotFound'] = 'File not found';
    $cn['AutoClose'] = 'Close on Complete';
    $cn['OutDocRoot'] = 'File beyond DOCUMENT_ROOT';
    $cn['NoCmd'] = 'Error: Command not informed';
    $cn['ConfTrySave'] = 'File without write permisson.\\nTry to save anyway';
    $cn['ConfSaved'] = '保存配置';
    $cn['PassSaved'] = '保存密码';
    $cn['FileDirExists'] = 'File or directory already exists';
    $cn['NoPhpinfo'] = 'Function phpinfo disabled';
    $cn['NoReturn'] = 'no return';
    $cn['FileSent'] = 'File sent';
    $cn['SpaceLimReached'] = 'Space limit reached';
    $cn['InvExt'] = 'Invalid extension';
    $cn['FileNoOverw'] = 'File could not be overwritten';
    $cn['FileOverw'] = 'File overwritten';
    $cn['FileIgnored'] = 'File ignored';
    $cn['ChkVer'] = 'Check for new version';
    $cn['ChkVerAvailable'] = 'New version, click here to begin download!!';
    $cn['ChkVerNotAvailable'] = 'No new version available. :(';
    $cn['ChkVerError'] = 'Connection Error.';
    $cn['Website'] = 'Website';
    $cn['SendingForm'] = 'Sending files, please wait';
    $cn['NoFileSel'] = 'No file selected';
    $cn['SelAll'] = 'All';
    $cn['SelNone'] = 'None';
    $cn['SelInverse'] = 'Inverse';
    $cn['Selected_s'] = 'selected';
    $cn['Total'] = 'total';
    $cn['Partition'] = 'Partition';
    $cn['RenderTime'] = 'Time to render this page';
    $cn['Seconds'] = 'sec';
    $cn['ErrorReport'] = 'Error Reporting';
